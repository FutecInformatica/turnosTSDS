...
class LocalidadesController extends Controller
{
    ...
    {
        $localidades = Localidad::orderBy('nombre')->paginate(10);
        $paises = Funciones::getPaisesSel();
        $provincias = Funciones::getProvinciasSel(1);
        return view('localidades.index', ['localidades' => $localidades, 'paises' => $paises, 'provincias' => $provincias]);
    }
