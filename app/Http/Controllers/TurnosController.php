...
class TurnosController extends Controller
{
    ...
    public function listado(Request $request)
    {
        ...
        if($request->get('aceptar') == 'pdf'){
            ...
            //preparamos el pdf con una vista separada
        ...
        //si el submit button es el que tiene el "value"='buscar'
            ...
            $request->get('fecha')? $fecha = Carbon::createFromFormat('Y-m-d', $request->get('fecha')) : $fecha = new Carbon();
    ...
    public function store(Request $request)
    {
        if(! Auth::user()->hasRole('admin')){
            ...
            $input = $request->all();
            $input['fecha'] = Carbon::createFromFormat('Y-m-d', $input['fecha'])->startOfDay();
