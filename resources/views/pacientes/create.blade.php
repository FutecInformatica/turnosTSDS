        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">                
                ...
                <div class="form-group">
                    ...
                    {!! Form::date('fechaNacimiento', \Carbon\Carbon::now()->format('dd-mm-YYYY'), ['class' => 'form-control datepicker', 'id' => 'fechaNacimiento_c']) !!}
                </div>
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('provincia_id', null, ['method' => 'GET', 'class' => 'form-control', 'id' => 'provincia_c']) !!}
                </div>-->

                <div class="form-group">
                    {!! Form::label('localidad_id', 'Localidad:', ['class' => 'control-label']) !!}
                    {!! Form::text('localidad_id', null, ['method' => 'GET', 'class' => 'form-control', 'id' => 'localidad_c']) !!}
                </div>
                ...
                <div class="form-group">
                    ...
                    {!! Form::checkbox('factura', null, false, ['method' => 'GET', 'id' => 'factura_c']) !!}
                </div>
                ...
                <div class="pull-right">
                    <a href="{{ route('pacientes.index') }}" class="btn btn-danger"></i>Cancelar</a>
                </div>
