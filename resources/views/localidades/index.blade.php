                            ...
                            @foreach ($localidades as $localidad)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {!! Form::button('<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>', ['class' => 'btn btn-warning btn-edit-localidad', 'type' => 'submit', 'data-id' => $localidad->id,  'data-toggle' => 'modal', 'data-target' => '#editModal']) !!}                                            
