                            ...
                            @foreach ($planes as $plan)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {!! Form::button('<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>', ['class' => 'btn btn-warning btn-edit-plan', 'type' => 'submit', 'data-id' => $plan->id,  'data-toggle' => 'modal', 'data-target' => '#editModal']) !!}                                            
