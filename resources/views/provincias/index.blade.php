                            ...
                            @foreach ($provincias as $provincia)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {!! Form::button('<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>', ['class' => 'btn btn-warning btn-edit-provincia', 'type' => 'submit', 'data-id' => $provincia->id,  'data-toggle' => 'modal', 'data-target' => '#editModal']) !!}                                            
