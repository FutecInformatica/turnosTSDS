                            ...
                            @foreach ($especialidades as $especialidad)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {!! Form::button('<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>', ['class' => 'btn btn-warning btn-edit-especialidad', 'type' => 'submit', 'data-id' => $especialidad->id,  'data-toggle' => 'modal', 'data-target' => '#editModal']) !!}                                            
