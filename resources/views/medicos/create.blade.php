        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">                
                ...
                <div class="form-group">
                    ...
                    {!! Form::date('fechaNacimiento', null, ['class' => 'form-control datepicker', 'id' => 'fechaNacimiento_c']) !!}
                </div>

                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    {!! Form::label('email', 'Email:', ['class' => 'control-label']) !!}
                    {!! Form::email('email', null, ['method' => 'GET', 'class' => 'form-control', 'id' => 'email_c']) !!}
                    @if ($errors->has('email'))
                        <span class="help-block">
                ...
                <div class="form-group{{ $errors->has('duracionTurno') ? ' has-error' : '' }}">
                    ...
                    {!! Form::text('duracionTurno', '00:00', ['id' => 'debe', 'class' => 'duracionTurno form-control', 'id' => 'duracionTurno_c']) !!}
                ...
                <div class="pull-right">
                    <a href="{{ route('medicos.index') }}" class="btn btn-danger"></i>Cancelar</a>
                </div>
