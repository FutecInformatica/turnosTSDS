                            ...
                            @foreach ($obras_sociales as $obra_social)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {!! Form::button('<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>', ['class' => 'btn btn-warning btn-edit-obra_social', 'type' => 'submit', 'data-id' => $obra_social->id,  'data-toggle' => 'modal', 'data-target' => '#editModal']) !!}                                            
