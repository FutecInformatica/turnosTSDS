                            ...
                            @foreach ($tipospago as $tipopago)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {!! Form::button('<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>', ['class' => 'btn btn-warning btn-edit-tipopago', 'type' => 'submit', 'data-id' => $tipopago->id,  'data-toggle' => 'modal', 'data-target' => '#editModal']) !!}                                            
